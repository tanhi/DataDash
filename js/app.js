...
En promedio: Acceder a tech sumarlos y dividir entre numero de sprints(number) for students[i] i<total de estudiantes for total += sprint[i].score.tech
Obtener promedio: total/número de sprints Verificar cuantas superan la meta: if total >= meta ponerlas en un contador Obtener porcentaje en referencia al total de alumnas: (contador x 100)/total de alumnas Por sprint*: Acceder a tech por sprint(number) Acceder a tech sumarlos y dividir entre numero de sprints(number) for total += sprint[i].score.tech for students[i] i<total de estudiantes Obtener promedio por sprint: total/número de alumnas Verificar cuantas superan la meta: if total >= meta ponerlas en un contador Obtener porcentaje en referencia al total de alumnas: (contador x 100)/total de alumnas
*/
...
En promedio: Acceder a HSE sumarlos y dividir entre numero de sprints(number) for students[i] i<total de estudiantes for total += sprint[i].score.hse
Obtener promedio: total/número de sprints Verificar cuantas superan la meta: if total >= meta ponerlas en un contador Obtener porcentaje en referencia al total de alumnas: (contador x 100)/total de alumnas Por sprint*: Acceder a HSE por sprint(number) Acceder a tech sumarlos y dividir entre numero de sprints(number) for total += sprint[i].score.hse for students[i] i<total de estudiantes Obtener promedio por sprint: total/número de alumnas Verificar cuantas superan la meta: if total >= meta ponerlas en un contador Obtener porcentaje en referencia al total de alumnas: (contador x 100)/total de alumnan
*/
